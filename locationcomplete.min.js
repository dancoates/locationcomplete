...
return;}}f.data("placeholder",f.attr("placeholder"));f.attr("placeholder",A.loadingMessage);f.attr("autocomplete","off");d();}function d(){if(r()&&localStorage.getItem("postcodeDataURL")===A.url){g(localStorage.getItem("postcodeData"));
