...
}else{y.addClass("lc-focused");}}function k(){var y=b(".lc-focused");e.val(y.text());n();}(function(){var C;var B=function(){};var z=["assert","clear","count","debug","dir","dirxml","error","exception","group","groupCollapsed","groupEnd","info","log","markTimeline","profile","profileEnd","table","time","timeEnd","timeStamp","trace","warn"];
